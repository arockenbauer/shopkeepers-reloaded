...
public class RegularVillagers {
	...
	private final ShopCreationEggEditListener shopCreationEggEditListener;
	...
	public RegularVillagers(SKShopkeepersPlugin plugin) {
		...
		this.shopCreationEggEditListener = new ShopCreationEggEditListener(plugin);
	...
	public void onEnable() {
		...
		Bukkit.getPluginManager().registerEvents(shopCreationEggEditListener, plugin);
	...
	public void onDisable() {
		...
		HandlerList.unregisterAll(shopCreationEggEditListener);
