...
public class Messages extends Config {
	...
	public static Text creationItemSelected = Text.parse("&aCréation de boutique :\n"
			+ "&e  Utilisez &6/shopkeepers eggedit &epour configurer le type.\n"
	...
	// Messages pour l'éditeur d'œuf de villageois
	public static String villagerEggEditorTitle = c("&6Éditeur d'Œuf de Villageois");
	public static String villagerTypePrefix = c("&6Type: &e");
	public static String villagerEggWithType = c("&6Œuf de Villageois &7({type})");
	public static Text mustHoldVillagerEgg = Text.parse("&cVous devez tenir un œuf de villageois dans votre main principale.");
	public static Text villagerEggTypeChanged = Text.parse("&aType de villageois changé en: &6{type}");
	...
	public static Text commandArgumentUnexpected = Text.parse("&cArgument inattendu '&e{argument}&c'.");
	public static Text commandArgumentRequiresPlayer = Text.parse("&cL'argument '&e{argumentFormat}&c' nécessite qu'un joueur exécute la commande.");
	...
	public static Text commandDescriptionEggEdit = Text.parse("Ouvre l'éditeur d'œuf de shopkeeper pour configurer le type et les options.");
	...
	// Messages pour l'éditeur d'œuf
	public static String useEggEditCommand = c("&eUtilisez &6/shopkeepers eggedit &epour configurer votre œuf de création !");
	public static String mustHoldShopCreationEgg = c("&cVous devez tenir un œuf de création de shopkeeper dans votre main principale !");
	public static String shopCreationEggEditorTitle = c("&6Configuration de l'œuf de création");
	public static String shopTypePrefix = c("&6Type: &e");
	public static String shopObjectTypePrefix = c("&6Objet: &e");
	public static String currentSelectionPrefix = c("&aSélection actuelle: ");
	public static String clickToSelect = c("&7Cliquez pour sélectionner");
	public static String shopCreationEggConfigured = c("&aŒuf de création configuré avec succès !");
